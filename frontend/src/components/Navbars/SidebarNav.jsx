...
function SidebarNav({ isAuthenticated, user, setModalHowlSubmit }) {
    ...
    try {
      ...
      if (caption === "") {
        ...
        const res = await fetch(
          "https://howler-backend.onrender.com/api/howl/createHowl",
          {
            method: "POST",
        ...
        >
          ...
          <div className="d-flex flex-column justify-content-between flex-grow-1">
            <div className="d-flex flex-column flex-grow-1 ">
              ...
              <AuthButton />
              <button
                className="btn btn-primary rounded-pill p-2 fs-5 fw-bold"
            ...
            <div
              role="button"
              className="btn btn-light rounded-pill container d-flex justify-content-start align-items-center p-2"
              style={{ height: "65px" }}
              onClick={() => navigate("/")}
            >
              <img
                src={user.picture}
                alt="profilepic"
                className="rounded-circle h-75 m-0"
              />
